...
module.exports = {
  ...
  plugins: [
    ...
    new htmlWebpackPlugin({
      filename: "index.html",
      template: "src/01.样式操作.html",
      template: "src/02.过滤器.html",
      template: "src/03.按键修饰符.html",
      template: "src/04.自定义指令.html",
      template: "src/06.vue生命周期.html",
      template: "src/07.watch.html",
      template: "src/05.品牌管理案例.html",
    }),
  ],
  module: {
    rules: [
